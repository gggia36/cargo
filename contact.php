...
<div class="container my-5 ">
  <div class="row nc-thumbnail">
    <div class="col-lg-6 col-12  d-flex align-items-center">
      <div>
        <img class=" w-100 img-contact" src="assets/images/Banner/banner-contact.jpg" >
      </div>
  ...
  อำเภอ บางบัวทอง จังหวัดนนทบุรี 11110</label>
          ...
          <li class="contact-item">
            ...
            <label class="text-contact">new_cargo@mail.com</label>
          </li>
        </ul>
      </div>
      ...
      <div class="info-contact ml-md-4 mb-4">
        ...
        <label style="font-weight: bold;">LineID : @Newcargo</label>
        <div class="line-contact">
          <img src="assets/images/qr_code.png" class="img-fluid" alt="Line Newcargo">
        </div>
      </div>
